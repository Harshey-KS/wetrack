...
const Login = () => {
    ...
    <div className="mb-4">
        ...
        <input type="email" placeholder="xyz@spit.ac.in" name="username" id="username" onChange={(e)=>{setEmail(e.currentTarget.value)}} value={email} className="border border-gray-300 rounded-md w-full p-2 mt-1" />
    </div>
    <div className="mb-4">
        <label htmlFor="password" className="block text-gray-700">Password</label>
        <input type="password" placeholder="********" name="password" id="password" onChange={(e)=>{setPassword(e.currentTarget.value)}} value={password} className="border border-gray-300 rounded-md w-full p-2 mt-1" />
    </div>
    ...
    <div className="mb-4">
        <button type="button" className="bg-red-500 hover:bg-red-700 text-white font-bold py-2 px-4 rounded" onClick={async()=>{
        ...
        }}><i className="fab fa-google fa-1x" ></i>   Log in with Google</button>
    </div>
